        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              and share your progress. Built for ambitious job seekers and new
              graduates.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-300 leading-relaxed">
                Store and organize all your resumes, cover letters, and
                portfolios in one secure, easily accessible location.
              </p>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-300 leading-relaxed">
                Your data is encrypted and secure. Control who sees what with
                granular privacy settings and secure sharing options.
              </p>
            </div>
          </div>
        </div>
