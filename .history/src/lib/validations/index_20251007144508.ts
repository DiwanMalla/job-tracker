...
export const paginationSchema = z.object({
  page: z.string().or(z.number()).transform((val) => parseInt(val.toString(), 10)).default(1),
  limit: z.string().or(z.number()).transform((val) => parseInt(val.toString(), 10)).default(10),
});
